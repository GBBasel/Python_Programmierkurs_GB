...
sound_car_racing = pygame.mixer.Sound("sound/car_racing.wav")  # car_racing.wav
sound_car_racing.set_volume(1.0)
sound_car_crash = pygame.mixer.Sound("sound/car_crash.wav")  # car_crash.wav
sound_car_crash.set_volume(1.0)
